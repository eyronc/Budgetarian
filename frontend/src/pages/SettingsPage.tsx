          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-5 sm:mb-6">
                      <div className={`w-11 h-11 sm:w-12 sm:h-12 bg-linear-to-br ${section.gradient} rounded-2xl flex items-center justify-center shadow-lg`}>
              ...
              <div className={`rounded-2xl sm:rounded-3xl p-4 sm:p-6 border shadow-xl transition-all duration-300 ${
                ...
                <div className="flex items-center gap-3 mb-5 sm:mb-6">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 bg-linear-to-br from-purple-400 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg">

...
const categories = [
  { name: 'Proteins',    amount: 210, emoji: '🥩', color: 'from-rose-400 to-red-500',      bg: 'bg-rose-500',    pct: 38 },
  { name: 'Vegetables',  amount: 95,  emoji: '🥦', color: 'from-emerald-400 to-green-500',  bg: 'bg-emerald-500', pct: 17 },
  { name: 'Grains',      amount: 85,  emoji: '🌾', color: 'from-amber-400 to-yellow-500',   bg: 'bg-amber-500',   pct: 15 },
  { name: 'Dairy',       amount: 70,  emoji: '🥛', color: 'from-blue-400 to-sky-500',       bg: 'bg-blue-500',    pct: 13 },
  { name: 'Condiments',  amount: 55,  emoji: '🫙', color: 'from-purple-400 to-violet-500',  bg: 'bg-purple-500',  pct: 10 },
  { name: 'Snacks',      amount: 40,  emoji: '🍪', color: 'from-orange-400 to-amber-500',   bg: 'bg-orange-500',  pct: 7  },
];
